...
for src in ["中央社政治","自由時報","聯合報","TVBS","ETtoday","三立","中天","風傳媒","Yahoo新聞","LINE NEWS"]:
    ...
    label = {"中央社政治":"官方通訊社","自由時報":"偏綠","聯合報":"平衡","TVBS":"中性偏綠","ETtoday":"中性","三立":"偏綠","中天":"偏藍","風傳媒":"偏藍/評論","Yahoo新聞":"聚合/綜合","LINE NEWS":"聚合/綜合"}.get(src, "")
...
for src in ["中央社國際","中央社政治","自由時報","聯合報","TVBS","ETtoday","三立","中天","風傳媒","Yahoo新聞","LINE NEWS"]:

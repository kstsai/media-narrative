...
> NT$15,000，拿到 1,069 筆台灣人設資料庫 + 查詢 CLI + 生成引擎。**可自行修改 regenerate，可賣改進後的 1069.json。但再生品質不保固。**
...
- **預算有限但想要完整功能** — NT$15K 拿到資料 + 生成引擎
- **自己有 QA 能力** — 能自行驗證 regenerate 品質
- **先試水再升級** — Lite 用得好，補差價 NT$45K-65K 升級到 Transfer 含 QA
